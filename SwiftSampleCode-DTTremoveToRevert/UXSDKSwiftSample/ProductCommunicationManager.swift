...
//Need a reference to CommunicationViewController instance here to be able to edit the text field with incoming data
//This is instantiated immediately so the reference must be created when CommunicationsViewController in initialized
...
class ProductCommunicationManager: NSObject, DJISDKManagerDelegate, DJIOnboardSDKDeviceDelegate{
    ...
    open var osdkDevice: DJIOnboardSDKDevice!
    ...
    func onboardSDKDevice(_ osdkDevice: DJIOnboardSDKDevice, didSendDataToMobile data: Data) {
        appDelegate?.communicationsViewController.DataDisplay.text = "Trying without data processing"
    }
    
    func onboardSDKDevice(_ osdkDevice: DJIOnboardSDKDevice, didActivateWithOnboardSDKVersion osdkVersion: String) {
        appDelegate?.communicationsViewController.DataDisplay.text = "Did activate with onboard sdk"
    }
